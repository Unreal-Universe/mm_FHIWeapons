class GrenadeTrailPPG extends xEmitter;
...
defaultproperties
{
     ...
     mColorRange(0)=(B=211,G=137,R=117,A=175)
     mColorRange(1)=(B=214,G=108,R=80,A=175)
     mRandTextures=True
     mNumTileColumns=4
     mNumTileRows=4
     Physics=PHYS_Trailer
     Skins(0)=Texture'EmitterTextures.MultiFrame.smoke_a'
     ScaleGlow=2.000000
