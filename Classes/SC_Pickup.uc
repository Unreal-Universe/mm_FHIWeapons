...
defaultproperties
{
     ...
     InventoryType=Class'mm_FHIWeapons.SingularityCannon'
     RespawnTime=60.000000
     PickupMessage="You got the Singularity Cannon."
     PickupSound=Sound'mm_FHIWeapons.FHISnd.Sing_Pickup'
     PickupForce="FlakCannonPickup"
     DrawType=DT_StaticMesh
     StaticMesh=StaticMesh'mm_FHIWeapons.FHIMesh.SCannonMesh'
     DrawScale=0.800000
}
