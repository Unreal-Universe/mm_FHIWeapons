...
defaultproperties
{
     ...
     ImpactSounds(0)=Sound'mm_FHIWeapons.FHISnd.Explode_Generic01'
     ImpactSounds(1)=Sound'mm_FHIWeapons.FHISnd.Explode_Generic06'
     ImpactSounds(2)=Sound'mm_FHIWeapons.FHISnd.Explode_Generic08'
     Speed=2350.000000
     MaxSpeed=2900.000000
     Damage=68.000000
     DamageRadius=175.000000
     MomentumTransfer=15000.000000
     MyDamageType=Class'mm_FHIWeapons.DamTypeMiniRocket'
     ...
     StaticMesh=StaticMesh'mm_FHIWeapons.FHIMesh.MiniRocketMesh'
     bDynamicLight=True
