...
defaultproperties
{
     FireModeClass(0)=Class'mm_FHIWeapons.RazorFire'
     FireModeClass(1)=Class'mm_FHIWeapons.RazorBombHeld'
     SelectAnim="Select"
     ...
     GroupOffset=71
     PickupClass=Class'mm_FHIWeapons.RazorBombPickup'
     PlayerViewOffset=(X=25.000000,Y=10.000000,Z=-8.000000)
     PlayerViewPivot=(Yaw=0,Roll=0)
     BobDamping=2.900000
     AttachmentClass=Class'mm_FHIWeapons.RazorBombAttachment'
     ItemName="RazorBomb"
     Mesh=SkeletalMesh'mm_FHIWeapons.FHIAnim.RazorBomb'
     DrawScale=1.690000
