...
defaultproperties
{
     FireModeClass(0)=Class'mm_FHIWeapons.LaserRifleFire'
     FireModeClass(1)=Class'mm_FHIWeapons.LaserRifleZoom'
     ...
     Priority=31
     GroupOffset=27
     PickupClass=Class'mm_FHIWeapons.LaserRiflePickup'
     BobDamping=2.900000
     AttachmentClass=Class'mm_FHIWeapons.LaserRifleAttachment'
