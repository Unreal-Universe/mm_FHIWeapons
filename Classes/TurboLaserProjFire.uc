...
defaultproperties
{
     ...
     FireSound=Sound'mm_FHIWeapons.FHISnd.TurboLaser_AltFire'
     ...
     ProjectileClass=Class'mm_FHIWeapons.TurboLaserProjectile'
     BotRefireRate=0.550000
     FlashEmitterClass=Class'mm_FHIWeapons.TurboLaserMuzFlash1st'
}
